      ...
      <div  className="pt-24">
        ...
        <div className="flex flex-col mb-10 mx-auto">
         ...
         <div className='flex flex-col w-full md:w-7/12'>
          ...
          <h1 className="text-3xl mb-1 md:mb-3 font-semibold">Juan Eulufi Salazar</h1>
          ...
          <p className="text-sm max-w-xl mb-6 text-justify pt-3 indent-3 lg:indent-5 ">
            ...
            to <span className='text-blue-500 dark:text-pink-500'>solving</span> real-life problems with code.
            <br />
            ...
            problems and learning from each <span className='text-blue-500 dark:text-pink-500'>new experience</span>.
          </p>
          </div>
        </div>
      </div>
